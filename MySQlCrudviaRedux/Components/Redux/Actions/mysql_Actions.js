...
export const Insertion = (Username, Password) => {
  return dispatch => {
    fetch(
      'http://192.168.0.51/Bverify/Components/MysqlDatabase/Mysql_Insertion.php',
      {
        method: 'POST',
        headers: {
...
export const listData = () => {
  return dispatch => {
    fetch('http://192.168.0.51/Bverify/Components/MysqlDatabase/Listing.php', {
      method: 'POST',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
...
export const Delete = id => {
  return dispatch => {
    fetch(
      'http://192.168.0.51/Bverify/Components/MysqlDatabase/DeleteRecord.php',
      {
        method: 'POST',
        headers: {
          Accept: 'application/json',
...
export const Update = (id, username, password) => {
  return dispatch => {
    fetch(
      'http://192.168.0.51/Bverify/Components/MysqlDatabase/UpdateAPI.php',
      {
        method: 'POST',
        headers: {
          Accept: 'application/json',
